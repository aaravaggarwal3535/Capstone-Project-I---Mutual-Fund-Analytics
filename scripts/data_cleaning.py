...
Purpose: Clean and preprocess the raw data files for further analysis.
"""
...
def clean_data(file_path, save_path):
    """
    Clean and preprocess the raw data files.
    """
    
    # cleaning the 01_fund_master.csv file
    fund_master = pd.read_csv(os.path.join(file_path, "01_fund_master.csv"))
    logging.info(f"First clearing fund_master.csv file:")
    logging.info(f"first 5 rows of the fund_master.csv file: \n{fund_master.head()}")
    logging.info(f"Shape of the fund_master.csv file: {fund_master.shape}")
    logging.info(f"info of the fund_master.csv file: \n{fund_master.info()}")
    logging.info(f"describe of the fund_master.csv file: \n{fund_master.describe()}")
    ...
    for i in fund_master.columns:
        if fund_master[i].dtype == 'object':
            if fund_master[i].isnull().sum() > 0:
                logging.info(f"there is a need to fix {i} column as there are null values and data type is also not correct")
            else:
                logging.info(f"{i} column has no null value but dtype needs to be fixed")
        else:
            if fund_master[i].isnull().sum() > 0:
                logging.info(f"there is a need to fix {i} column as there are null values but dtype is correct")
            else:
                logging.info(f"{i} column has correct dtype and no null values")
    # finding the number of duplicated rows in the data
    duplicate_rows = fund_master.duplicated().sum()
    if duplicate_rows > 0:
        logging.info(f"There are {duplicate_rows} duplicated rows in the data")
        ...
        logging.info("There are no duplicated rows in the data")
    ...
    logging.info(f"Now clearing nav_history.csv file:")
    logging.info(f"first 5 rows of the nav_history.csv file: \n{nav_history.head()}")
    logging.info(f"Shape of the nav_history.csv file: {nav_history.shape}")
    logging.info(f"info of the nav_history.csv file: \n{nav_history.info()}")
    logging.info(f"describe of the nav_history.csv file: \n{nav_history.describe()}")
    ...
    logging.info(f"Now clearing aum_by_fund_house.csv file:")
    logging.info(f"first 5 rows of the aum_by_fund_house.csv file: \n{aum_by_fund_house.head()}")
    logging.info(f"Shape of the aum_by_fund_house.csv file: {aum_by_fund_house.shape}")
    logging.info(f"info of the aum_by_fund_house.csv file: \n{aum_by_fund_house.info()}")
    logging.info(f"describe of the aum_by_fund_house.csv file: \n{aum_by_fund_house.describe()}")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Now clearing monthly_sip_inflows.csv file:")
    logging.info(f"first 5 rows of the monthly_sip_inflows.csv file: \n{monthly_sip_inflows.head()}")
    logging.info(f"Shape of the monthly_sip_inflows.csv file: {monthly_sip_inflows.shape}")
    logging.info(f"info of the monthly_sip_inflows.csv file: \n{monthly_sip_inflows.info()}")
    logging.info(f"describe of the monthly_sip_inflows.csv file: \n{monthly_sip_inflows.describe()}")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Now clearing category_inflows.csv file:")
    logging.info(f"first 5 rows of the category_inflows.csv file: \n{category_inflows.head()}")
    logging.info(f"Shape of the category_inflows.csv file: {category_inflows.shape}")
    logging.info(f"info of the category_inflows.csv file: \n{category_inflows.info()}")
    logging.info(f"describe of the category_inflows.csv file: \n{category_inflows.describe()}")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Now clearing industry_folio_count.csv file:")
    logging.info(f"first 5 rows of the industry_folio_count.csv file: \n{industry_folio_count.head()}")
    logging.info(f"Shape of the industry_folio_count.csv file: {industry_folio_count.shape}")
    logging.info(f"info of the industry_folio_count.csv file: \n{industry_folio_count.info()}")
    logging.info(f"describe of the industry_folio_count.csv file: \n{industry_folio_count.describe()}")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Now clearing scheme_performance.csv file:")
    logging.info(f"first 5 rows of the scheme_performance.csv file: \n{scheme_performance.head()}")
    logging.info(f"Shape of the scheme_performance.csv file: {scheme_performance.shape}")
    logging.info(f"info of the scheme_performance.csv file: \n{scheme_performance.info()}")
    logging.info(f"describe of the scheme_performance.csv file: \n{scheme_performance.describe()}")
    ...
    if 'sharpe_ratio' in scheme_performance.columns:
        ...
        if scheme_performance[scheme_performance['negative_sharpe_flag'] == True].empty:
            logging.info("No entries with negative sharpe_ratio found.")
        else:
            logging.info(f"Found {scheme_performance[scheme_performance['negative_sharpe_flag'] == True].shape[0]} entries with negative sharpe_ratio.")
    else:
        logging.info("sharpe_ratio column not found in scheme_performance.csv.")
    ...
    if 'expense_ratio_pct' in scheme_performance.columns:
        ...
        logging.info("expense_ratio_pct column not found in scheme_performance.csv.")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Number of duplicated rows: {duplicate_rows}")
    if duplicate_rows > 0:
        logging.info(f"There are {duplicate_rows} duplicated rows in the data")
        # removing the duplicated rows from the data and keeping the first occurrence
    ...
    logging.info(f"Now clearing investor_transaction.csv file:")
    logging.info(f"first 5 rows of the investor_transaction.csv file: \n{investor_transaction.head()}")
    logging.info(f"Shape of the investor_transaction.csv file: {investor_transaction.shape}")
    logging.info(f"info of the investor_transaction.csv file: \n{investor_transaction.info()}")
    logging.info(f"describe of the investor_transaction.csv file: \n{investor_transaction.describe()}")
    ...
    if list(investor_transaction['transaction_type'].unique()) != valid_transaction_types:
        logging.info(f"Invalid transaction types found in investor_transaction.csv: {list(investor_transaction['transaction_type'].unique())}")
    else:
        logging.info("All transaction types are valid.")
    ...
    logging.info(f"Now clearing portfolio_holdings.csv file:")
    logging.info(f"first 5 rows of the portfolio_holdings.csv file: \n{portfolio_holdings.head()}")
    logging.info(f"Shape of the portfolio_holdings.csv file: {portfolio_holdings.shape}")
    logging.info(f"info of the portfolio_holdings.csv file: \n{portfolio_holdings.info()}")
    logging.info(f"describe of the portfolio_holdings.csv file: \n{portfolio_holdings.describe()}")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Saving the cleaned portfolio_holdings.csv file to {save_path} directory as all the column and data types are correct and there are no null values and no duplicated values")
    ...
    logging.info(f"Now clearing benchmark_indices.csv file:")
    logging.info(f"first 5 rows of the benchmark_indices.csv file: \n{benchmark_indices.head()}")
    logging.info(f"Shape of the benchmark_indices.csv file: {benchmark_indices.shape}")
    logging.info(f"info of the benchmark_indices.csv file: \n{benchmark_indices.info()}")
    logging.info(f"describe of the benchmark_indices.csv file: \n{benchmark_indices.describe()}")
    # checking if there is any null value left in the data and if there are any columns with mismatched dtype
    ...
    logging.info(f"Saving the cleaned benchmark_indices.csv file to {save_path} directory as all the column and data types are correct and there are no null values and no duplicated values")
